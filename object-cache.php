 ...
 * Plugin URI: https://wordpress.org/extend/plugins/memcached/
 * Description: Memcached backend for the WP Object Cache.
 * Text Domain: memcached
 * Author: Ryan Boren, Denis de Bernardy, Matt Martz, Andy Skelton
 * Author URI: https://wordpress.org/extend/plugins/memcached/
...
/**
 * Wp Cahce Add Non Persistent Groups.
 *
 * @access public
 * @param mixed $groups Groups.
 */
...
class WP_Object_Cache {
	 ...
	 * @param mixed  $id ID.
	 * @param mixed  $data Data.
	 * @param string $group (default: 'default') Group.
	 * @param int    $expire (default: 0) Expire.
	 */
